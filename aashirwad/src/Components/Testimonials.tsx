  ...
  return (
    <>
      <div className="bg-[#ecf3f3] py-16">
        <div className="flex mx-auto text-center md:w-1/2 lg:w-1/3 w-11/12">
          <div className="flex flex-col gap-5">
            <div className=" w-full text-center">
              ...
              <h1 className="font-serif -mt-10 lg:-mt-16  text-[#10377a] lg:text-6xl">
                TESTIMONIALS
              </h1>
            </div>
        ...
        <div className="slider-container w-full overflow-hidden px-10 py-20 ">
          <Slider {...settings}>
            <div className="flex flex-col text-center space-y-5 p-10 hover:bg-white shadow-md">
